...
library(dplyr)
library(lubridate)
library(stringi,lib.loc = '/Net/Groups/BGI/scratch/xyu/R_libs/x86_64-pc-linux-gnu-library/4.2')
library(Kendall)
library(zoo)
library(rstatix)
library(ggpubr,lib.loc = '/Net/Groups/BGI/scratch/xyu/R_libs/x86_64-pc-linux-gnu-library/4.2')
...
############## read data ###############
    ...
    folder_path_stat<-paste0(rootpath,'/2nd_writing_SA/response_code/stat_test_',case_run,'/')
